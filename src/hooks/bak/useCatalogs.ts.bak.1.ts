...
export const useCatalogs = () => {
  ...
  // FIXED: Use useCallback to stabilize the loadCatalogs function
  ...
  }, [setCatalogs, setLoading, setError, setStatus]); // FIXED: Include all dependencies

  // FIXED: Include loadCatalogs in dependency array
  useEffect(() => {
    // Only load if:
  ...
  }, [catalogs.length, loading, loadCatalogs]); // FIXED: Added loadCatalogs to dependencies
