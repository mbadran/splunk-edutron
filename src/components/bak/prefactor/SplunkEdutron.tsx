  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="flex-1 p-6 bg-gray-100 mt-6">
        <p className="text-gray-600 mb-4 italic">Click on the cells below to select the required courses for each team member.</p>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-800 via-slate-700 to-blue-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white">Loading course catalog...</p>
        </div>
      </div>
    );
  }
