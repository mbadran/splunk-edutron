...
interface BaseTable2Props<TData> {
  ...
  footerProps?: Omit<TableFooterProps, 'className'>;
  ...
  <TData,>(
    ...
    const getRowClassName = (rowIndex: number) => {
      ...
      if (enableAlternatingRows) {
        classes += rowIndex % 2 === 0 ? " bg-white" : " bg-gray-100";
      }
    ...
    const renderEmptyState = () => (
      <div id="table-empty-state" className="flex items-center justify-center h-32">
      ...
      >
            ...
            {loadingState
              ...
              : rows.length === 0
                ...
                : rows.map((row, rowIndex) => {
                    const courseData = row.original as any;
                      ...
                      >
                        {row.getVisibleCells().map((cell, cellIndex) => {
                          ...
                          return (
                            <div
                              key={cell.id}
                              id={isNameColumn ? `course-name-${rowIndex + 1}` : undefined}
        ...
        {(footerProps || footerMessage) && (
          footerProps ? (
            ...
            <div id="table-footer-container" className="flex-shrink-0 px-4 py-3 bg-gray-400 border-t border-gray-100">
              <span
                id="table-footer"
