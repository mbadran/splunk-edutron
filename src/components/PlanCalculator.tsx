...
const PlanCalculator = () => {
  // Use plan state and total from global atoms exclusively
  ...
  return (
    <div id="calculator" className="flex w-full min-w-0">
                  ...
                  <div className="relative group">
                    ...
                    >
                      <div className="grid grid-cols-[12px_12px_1fr_auto] items-center gap-0">
                        ...
                        <span id="budget-value" className="text-left">
          ...
          <div className="relative">
            ...
            >
              <div className="grid grid-cols-[12px_12px_1fr_auto_auto] items-center gap-0">
                ...
                <span id="total-value" className="text-orange-400 text-left">
